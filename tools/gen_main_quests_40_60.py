...
# ===== 下邳 40-46 (14 个) =====
QUESTS += [
dict(id="main_all_40a", name="共·烽烟初探", type="main",
...
dict(id="main_all_40b", name="共·夜巷妖影", type="main",
     npc_id="npc_xiapi_center_水镜先生", npc_name="水镜先生",
     npc_location="xiapi_center.广场", npc_location_name="广场(下邳中区)",
...
dict(id="main_all_41a", name="共·文姬之秘", type="main",
...
dict(id="main_all_41b", name="共·钱庄暗账", type="main",
...
dict(id="main_all_42a", name="共·截江夺货", type="main",
     npc_id="npc_xiapi_center_糜竺", npc_name="糜竺",
     npc_location="xiapi_center.钱庄", npc_location_name="钱庄(下邳中区)",
...
dict(id="main_all_42b", name="共·影中之人", type="main",
...
dict(id="main_all_43a", name="共·客栈惊变", type="main",
     npc_id="npc_xiapi_center_蔡文姬", npc_name="蔡文姬",
     npc_location="xiapi_center.客栈", npc_location_name="客栈(下邳中区)",
...
dict(id="main_all_43b", name="共·旧臣筹谋", type="main",
...
dict(id="main_all_44a", name="共·截获密信", type="main",
     npc_id="npc_xiapi_center_陈宫", npc_name="陈宫",
     npc_location="xiapi_center.太守府", npc_location_name="太守府(下邳中区)",
...
dict(id="main_all_44b", name="共·密信呈交", type="main",
     npc_id="npc_xiapi_center_陈宫", npc_name="陈宫",
     npc_location="xiapi_center.太守府", npc_location_name="太守府(下邳中区)",
...
dict(id="main_all_45a", name="共·文姬随行", type="main",
     npc_id="npc_xiapi_center_蔡文姬", npc_name="蔡文姬",
     npc_location="xiapi_center.客栈", npc_location_name="客栈(下邳中区)",
...
dict(id="main_all_45b", name="共·东郊突围", type="main",
     npc_id="npc_xiapi_center_蔡文姬", npc_name="蔡文姬",
     npc_location="xiapi_center.客栈", npc_location_name="客栈(下邳中区)",
...
dict(id="main_all_46a", name="共·水镜赠言", type="main",
     npc_id="npc_xiapi_center_水镜先生", npc_name="水镜先生",
     npc_location="xiapi_center.广场", npc_location_name="广场(下邳中区)",
...
dict(id="main_all_46b", name="共·下邳落幕", type="main",
     npc_id="npc_xiapi_center_水镜先生", npc_name="水镜先生",
     npc_location="xiapi_center.广场", npc_location_name="广场(下邳中区)",
...
# ===== 江陵 47-51 (10 个) =====
QUESTS += [
dict(id="main_all_47a", name="共·江陵初临", type="main",
...
dict(id="main_all_47b", name="共·船王之诺", type="main",
...
dict(id="main_all_48a", name="共·夜潜水寨", type="main",
     npc_id="npc_jiangling_center_苏飞", npc_name="苏飞",
     npc_location="jiangling_center.钱庄", npc_location_name="钱庄(江陵中区)",
...
dict(id="main_all_48b", name="共·文姬遇险", type="main",
...
dict(id="main_all_49a", name="共·密室夺图", type="main",
     npc_id="npc_jiangling_center_苏飞", npc_name="苏飞",
     npc_location="jiangling_center.钱庄", npc_location_name="钱庄(江陵中区)",
...
dict(id="main_all_49b", name="共·拓片辨真", type="main",
     npc_id="npc_jiangling_center_黄承彦", npc_name="黄承彦",
     npc_location="jiangling_center.广场", npc_location_name="广场(江陵中区)",
...
dict(id="main_all_50a", name="共·守将迟疑", type="main",
...
dict(id="main_all_50b", name="共·江陵余烬", type="main",
     npc_id="npc_jiangling_center_黄祖", npc_name="黄祖",
     npc_location="jiangling_center.太守府", npc_location_name="太守府(江陵中区)",
...
dict(id="main_all_51a", name="共·入汉道中", type="main",
     npc_id="npc_jiangling_center_蔡文姬", npc_name="蔡文姬",
     npc_location="jiangling_center.客栈", npc_location_name="客栈(江陵中区)",
...
dict(id="main_all_51b", name="共·褒斜截杀", type="main",
     npc_id="npc_jiangling_center_蔡文姬", npc_name="蔡文姬",
     npc_location="jiangling_center.客栈", npc_location_name="客栈(江陵中区)",
...
# ===== 汉中 52-54 (6 个) =====
QUESTS += [
dict(id="main_all_52a", name="共·镇北迎宾", type="main",
...
dict(id="main_all_52b", name="共·隐士机要", type="main",
...
dict(id="main_all_53a", name="共·夜夺火库", type="main",
     npc_id="npc_hanzhong_center_田豫", npc_name="田豫",
     npc_location="hanzhong_center.广场", npc_location_name="广场(汉中中区)",
...
dict(id="main_all_53b", name="共·断粮夺图", type="main",
     npc_id="npc_hanzhong_center_田豫", npc_name="田豫",
     npc_location="hanzhong_center.广场", npc_location_name="广场(汉中中区)",
...
dict(id="main_all_54a", name="共·图穷名现", type="main",
     npc_id="npc_hanzhong_center_胡昭", npc_name="胡昭",
     npc_location="hanzhong_center.酒馆", npc_location_name="酒馆(汉中中区)",
...
dict(id="main_all_54b", name="共·汉中山岳", type="main",
     npc_id="npc_hanzhong_center_田豫", npc_name="田豫",
     npc_location="hanzhong_center.广场", npc_location_name="广场(汉中中区)",
...
# ===== 洛阳 55-60 (12 个) =====
QUESTS += [
dict(id="main_all_55a", name="共·残汉开门", type="main",
...
dict(id="main_all_55b", name="共·宫门初战", type="main",
     npc_id="npc_luoyang_center_荀爽", npc_name="荀爽",
     npc_location="luoyang_center.广场", npc_location_name="广场(洛阳中区)",
...
dict(id="main_all_56a", name="共·深宫对峙", type="main",
...
dict(id="main_all_56b", name="共·影刃当前", type="main",
...
dict(id="main_all_57a", name="共·虎豹精锐", type="main",
...
dict(id="main_all_57b", name="共·文姬入洛", type="main",
...
dict(id="main_all_58a", name="共·总坛外垣", type="main",
     npc_id="npc_luoyang_center_荀爽", npc_name="荀爽",
     npc_location="luoyang_center.广场", npc_location_name="广场(洛阳中区)",
...
dict(id="main_all_58b", name="共·焚书断根", type="main",
     npc_id="npc_luoyang_center_荀爽", npc_name="荀爽",
     npc_location="luoyang_center.广场", npc_location_name="广场(洛阳中区)",
...
dict(id="main_all_59a", name="共·殿前死战", type="main",
     npc_id="npc_luoyang_center_影", npc_name="影",
     npc_location="luoyang_center.酒馆", npc_location_name="酒馆(洛阳中区)",
...
dict(id="main_all_59b", name="共·四象守阵", type="main",
     npc_id="npc_luoyang_center_残汉老臣", npc_name="残汉老臣",
     npc_location="luoyang_center.军营", npc_location_name="军营(洛阳中区)",
...
dict(id="main_all_60a", name="共·玉玺归处", type="main",
     npc_id="npc_luoyang_center_荀爽", npc_name="荀爽",
     npc_location="luoyang_center.广场", npc_location_name="广场(洛阳中区)",
...
dict(id="main_all_60b", name="共·烽火终章", type="main",
     npc_id="npc_luoyang_center_烛龙", npc_name="烛龙",
     npc_location="luoyang_center.皇宫", npc_location_name="皇宫(洛阳中区)",
